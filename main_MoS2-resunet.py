...
print('ResUNet model for MoS2 dataset')
...
def train():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        model.loss_acc['train_acc'].append(np.array(train_acc)) #RESOLVER AQUIIII PROB .NUMPY()
        ...
        save_loss(model=model, name='./mos2_resunet_results/MoS2_resunet_loss_acc')
        ...
        if avg_vloss < best_vloss:
            ...
            save_checkpoint(checkpoint, name='./mos2_resunet_results/MoS2_resunet_best_model_checkpoint.pth.tar')
        else:
            counter += 1
        if counter > patience:
